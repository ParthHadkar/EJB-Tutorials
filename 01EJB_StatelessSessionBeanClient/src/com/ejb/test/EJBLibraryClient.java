...
public class EJBLibraryClient 
{
	...
	private void testStatelessEjb()
	{
		try {
			int choice = 0;
			LibrarySessionBeanRemote librarySessionBeanRemote = (LibrarySessionBeanRemote) ctx.lookup("01EJB_StatelessSessionBean/LibraryStatelessSessionBean/remote");
			//LibrarySessionBeanLocal librarySessionBeanLocal = (LibrarySessionBeanLocal) ctx.lookup("01EJB_StatelessSessionBean/LibraryStatelessSessionBean/local");
			while(choice != 3) 
			{
				showGui();
			...
			LibrarySessionBeanRemote librarySessionBeanRemote1 = (LibrarySessionBeanRemote) ctx.lookup("01EJB_StatelessSessionBean/LibraryStatelessSessionBean/remote");
			//LibrarySessionBeanLocal librarySessionBeanLocal1 = (LibrarySessionBeanLocal) ctx.lookup("01EJB_StatelessSessionBean/LibraryStatelessSessionBean/local");
