...
public class EJBLibraryClient 
{
	...
	private void testStatelessEjb()
	{
		try {
			int choice = 0;
			LibrarySessionBeanRemote librarySessionBeanRemote = (LibrarySessionBeanRemote) ctx.lookup("03EJB_LibraryPersistanceBean/LibraryPersistanceBean/remote");
			//LibrarySessionBeanLocal librarySessionBeanLocal = (LibrarySessionBeanLocal) ctx.lookup("03EJB_LibraryPersistanceBean/LibraryPersistanceBean/local");
			while(choice != 3) 
			{
				showGui();
			...
			LibrarySessionBeanRemote librarySessionBeanRemote1 = (LibrarySessionBeanRemote) ctx.lookup("03EJB_LibraryPersistanceBean/LibraryPersistanceBean/remote");
			//LibrarySessionBeanLocal librarySessionBeanLocal1 = (LibrarySessionBeanLocal) ctx.lookup("03EJB_LibraryPersistanceBean/LibraryPersistanceBean/local");
