...
public class LibraryPersistanceBean implements LibrarySessionBeanLocal,LibrarySessionBeanRemote 
{
    ...
    public void postConstruct() {
    	System.out.println(getClass().getSimpleName()+" PostConstruct bean Created");
    }
    
    @PreDestroy
    public void preDestroy() {
    	System.out.println(getClass().getSimpleName()+" PreDestroy bean Destroy");
    }
    
    @PostActivate
    public void postActivate() {
    	System.out.println(getClass().getSimpleName()+" PostActivate bean Activated");
    }
    
    @PrePassivate
    public void prePassivate() {
    	System.out.println(getClass().getSimpleName()+" PrePassivate bean Passivated");
    }
}
