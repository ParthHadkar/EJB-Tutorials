...
import com.ejb.interceptor.BusinessInterceptor;
import com.ejb.model.Book;

@Interceptors({BusinessInterceptor.class}) // class level
...
public class LibraryPersistanceBean implements LibrarySessionBeanLocal,LibrarySessionBeanRemote 
{
   ...
   /* @Interceptors({LibraryPersistanceBean.class}) // method level
