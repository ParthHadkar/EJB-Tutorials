...
public class EJBLibraryClient 
{
	...
	private void showBooks(LibrarySessionBeanLocal lsr) 
	{
		try {
		List<Book> books = lsr.getBooks();
		System.out.println(books+" Book entered so far: "+books.size());
		for(int i=0; i<books.size(); i++) 
		{
			System.out.println(i+1+". Book Name: "+books.get(i).getName()+" Book Author: "+books.get(i).getAuthor());
		}
	...
	private void testStatefulEjb()
	{
		try {
			int choice = 0;
			LibrarySessionBeanRemote librarySessionBeanRemote = (LibrarySessionBeanRemote) ctx.lookup("02EJB_StatefulSessionBean/LibraryStatefulSessionBean/remote");
			//LibrarySessionBeanLocal librarySessionBeanLocal = (LibrarySessionBeanLocal) ctx.lookup("02EJB_StatefulSessionBean/LibraryStatefulSessionBean/local");
			while(choice != 3) 
			{
				showGui();
			...
			LibrarySessionBeanRemote librarySessionBeanRemote1 = (LibrarySessionBeanRemote) ctx.lookup("02EJB_StatefulSessionBean/LibraryStatefulSessionBean/remote");
			//LibrarySessionBeanLocal librarySessionBeanLocal1 = (LibrarySessionBeanLocal) ctx.lookup("02EJB_StatefulSessionBean/LibraryStatefulSessionBean/local");
	...
	public static void main(String[] args) {
		...
		ejbLibraryClient.testStatefulEjb();
	}
