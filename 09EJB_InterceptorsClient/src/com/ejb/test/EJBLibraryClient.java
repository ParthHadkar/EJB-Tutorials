...
public class EJBLibraryClient 
{
	...
	private void testStatelessEjb()
	{
		try {
			int choice = 0;
			LibrarySessionBeanRemote librarySessionBeanRemote = (LibrarySessionBeanRemote) ctx.lookup("09EJB_Interceptors/LibraryPersistanceBean/remote");
			//LibrarySessionBeanLocal librarySessionBeanLocal = (LibrarySessionBeanLocal) ctx.lookup("09EJB_Interceptors/LibraryPersistanceBean/local");
			while(choice != 3) 
			{
				showGui();
			...
			LibrarySessionBeanRemote librarySessionBeanRemote1 = (LibrarySessionBeanRemote) ctx.lookup("09EJB_Interceptors/LibraryPersistanceBean/remote");
			//LibrarySessionBeanLocal librarySessionBeanLocal1 = (LibrarySessionBeanLocal) ctx.lookup("09EJB_Interceptors/LibraryPersistanceBean/local");
